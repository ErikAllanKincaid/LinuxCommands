...
$> "use-desktop-grid"
##==========================================
## Change the window movement modifier key from Alt to the Super (Windows) key:
...
## Start window and pane indices from 1 instead of 0
$>    set -g base-index 1
...
$>    set -g status-bg colour235 ## background color (gray)
$>    set -g status-fg colour255 ## foreground color (white)
$>    set -g status-left '#[fg=green]Session: #S #[fg=yellow]Pane: #P '
$>    set -g status-right '#[fg=cyan]%H:%M %d-%b-%y' ## time and date
$>    set -g status-justify centre ## center window list
## Reload the config file with 'Prefix + r'
$>    bind r source-file ~/.tmux.conf \; display-message "Config reloaded!"
## Use more intuitive split keys: Remap the vertical and horizontal split commands from " and % to - and =.
$>    bind = split-window -h
$>    bind - split-window -v
## Increase history limit: Increase the number of lines kept in the window history.
$>    set-option -g history-limit 5000
## Enable mouse support: Allows scrolling and resizing panes with the mouse.
$>    set -g mouse on
##==========================================
## ###############################################
## ##    END tmux Sessions
...
$> which zsh
$> chsh -s $(which zsh)
## Install fzf fuzzy finder with git.
$> git clone --depth 1 https://github.com/junegunn/fzf.git ~/.fzf
$> ~/.fzf/install
##    Will ask to install binding etc.
## Set up fzf key bindings and fuzzy completion
$> source < (fzf --zsh)
## Fuzzy Search for files interactively
$> find . -type f | fzf
## Fuzzy Search inside files (with ripgrep):
$> rg . | fzf
## Open a file in Vim:
$> vim $(fzf)
##------------------------------
...
$> cp ./basalt-0.11.2-x86_64-unknown-linux-musl/target/x86_64-unknown-linux-musl/release/basalt /usr/local/bin/
$> ls /usr/local/bin/
##==========================================
...
$>     lazydocker
$> cp ./lazydocker_0.24.3_Linux_x86_64/lazydocker /usr/local/bin/
$> sudo /usr/local/bin/lazydocker
##==========================================
